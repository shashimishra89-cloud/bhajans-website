...
const aartiData = {
  ...
  lyrics: {
    sanskrit: [
      ...
      "त्वां नित्यं सेवन्ते, सर्वे विषया विराटाः",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-yellow-100 to-amber-100 rounded-2xl shadow-xl p-8 md:p-12 border border-yellow-200">
            <div className="text-center">
              <div className="w-24 h-24 bg-gradient-to-br from-yellow-400 to-amber-400 rounded-full mx-auto mb-6 flex items-center justify-center">
