      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          {festival.rituals && festival.rituals.length > 0 && (
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">Rituals & Traditions</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {festival.rituals.map((ritual, index) => (
                  <div key={index} className="bg-white/80 backdrop-blur-sm p-4 rounded-lg border border-orange-100">
                    <div className="flex items-center space-x-2">
